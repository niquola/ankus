...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__34369__auto__,writer__34370__auto__,opt__34371__auto__){
return cljs.core._write.call(null,writer__34370__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__35625 = o;
(G__35625[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__33751__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__33751__auto__){
var and__33751__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__33751__auto____$1){
var and__33751__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__33751__auto____$2)){
return (jsprops["hasOwnProperty"])("value");
} else {
return and__33751__auto____$2;
}
} else {
...
var G__35633 = jsprops;
(G__35633["defaultValue"] = value);

(G__35633["onChange"] = ((function (G__35633,v,value,on_change){
return (function (p1__35631_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__35631_SHARP_);
});})(G__35633,v,value,on_change))
);
...
var vec__35638 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__35638,(0),null);
var id = cljs.core.nth.call(null,vec__35638,(1),null);
var class$ = cljs.core.nth.call(null,vec__35638,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___35641 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___35641 == null)){
} else {
var key_35642 = temp__4661__auto___35641;
...
var G__35644 = (new reagent.impl.template.NativeWrapper());
(G__35644["name"] = c);
...
var len__34832__auto___35650 = arguments.length;
var i__34833__auto___35651 = (0);
while(true){
if((i__34833__auto___35651 < len__34832__auto___35650)){
args__34839__auto__.push((arguments[i__34833__auto___35651]));

var G__35652 = (i__34833__auto___35651 + (1));
i__34833__auto___35651 = G__35652;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__34840__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35648){
var G__35649 = cljs.core.first.call(null,seq35648);
var seq35648__$1 = cljs.core.next.call(null,seq35648);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__35649,seq35648__$1);
});
...
break;
default:
var G__35656 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__35656;
continue;
...
var n__34677__auto___35657 = a.length;
var i_35658 = (0);
while(true){
if((i_35658 < n__34677__auto___35657)){
(a[i_35658] = reagent.impl.template.as_element.call(null,(a[i_35658])));
...
var a = cljs.core.into_array.call(null,s);
var n__34677__auto___35660 = a.length;
var i_35661 = (0);
while(true){
if((i_35661 < n__34677__auto___35660)){
var val_35662 = (a[i_35661]);
if((cljs.core.vector_QMARK_.call(null,val_35662)) && ((reagent.impl.template.key_from_vec.call(null,val_35662) == null))){
(o["no-key"] = true);
} else {
}

(a[i_35661] = reagent.impl.template.as_element.call(null,val_35662));
...
var ctx = {};
var vec__35665 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__35665,(0),null);
var derefed = cljs.core.nth.call(null,vec__35665,(1),null);
...
var G__35667 = (cljs.core.count.call(null,argv) - first_child);
switch (G__35667) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__35667){
